...
return ( <div className='w-full bg-zinc-800 py-[15vh] rounded-tr-3xl rounded-tl-3xl'> <div className='border-b-2 border-zinc-700 text-[8vh]'> <div className='mb-6 px-[50px]'>Our Projects</div> </div>
    ...
    <div className='h-screen w-full flex gap-5'>
      ...
      <div className='w-1/2 h-full'>
        <div className='flex items-center'>
          ...
          <div className='uppercase font-extralight'>recap 1</div>
        </div>
        ...
        <motion.div
          ...
          className='relative transition-transform duration-500 ease-in-out overflow-visible bg-cover bg-center h-[80vh] w-full my-5 rounded-2xl'
        >
      ...
      <div className='w-1/2 h-full'>
        <div className='flex items-center'>
          <div className='rounded-full bg-white h-2 w-2 m-1'></div>
          <div className='uppercase font-extralight'>PPIT Nanjing</div>
        </div>
        ...
        >
          <h1 className='absolute flex text-9xl overflow-hidden text-[#f15025] leading-none font-[grotesk] right-full -translate-y-1/2 translate-x-1/2 z-10 top-1/2 uppercase w-[150vh] justify-center'>
            {"ppit nanjing".split('').map((item, index) => (
              <motion.span
                key={index}
                className='inline-block'
                initial={{ y: "100%" }}
...
```
    ...
    <div className='w-full flex justify-center items-center'>
      <button
        onMouseEnter={buttonHoverStart}
        onMouseLeave={buttonHoverEnd}
        className="relative w-90 h-16 bg-zinc-800 border-2 border-white rounded-full text-white flex items-center justify-between pl-6 pr-2 group overflow-hidden"
      >
        <span className="z-10 text-white text-[2vh] tracking-wide uppercase group-hover:text-black">
          View Our Journey @ppit_nanjing
        </span>
